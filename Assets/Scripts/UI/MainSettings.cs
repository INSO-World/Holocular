...
public class MainSettings : MonoBehaviour
{
    ...
    public Vector2 mainSettingsScrollPosition = Vector2.zero;
    ...
    void Start()
    {
        ...
        showHotspotColorsSwitch = new Switch(new Rect(0, 150, 40, 20), switchBackground, switchKnob);
    ...
    {
        window.render();
        mainSettingsScrollPosition = GUI.BeginScrollView(new Rect(0, 30, 300, 770), mainSettingsScrollPosition, new Rect(0, 0, 280, 900));

        if (GUI.Button(new Rect(10, 10, 280, 20), "Open Database"))
        {
            OpenFolder();
        }

        if (GUI.Button(new Rect(10, 35, 280, 20), "Delete Helix"))
        {
            Main.helix.DeleteHelix();
        }

        if (GUI.Button(new Rect(10, 60, 280, 20), "Stop Helix Generation"))
        {
